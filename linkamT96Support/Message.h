...
namespace LinkamSDK
{
    ...
    enum LinkamFunctionMsgCode
    {
        ...
        /*!
         *  \brief          Send this message to the driver to prevent support for log files.
         *
         * Dy default logging is enabled within the driver. Logging allows developers to record error events
        ...
        /*!
         *  \brief          Send this message to the driver to allow support for log files to be created.
         *
         * Dy default logging is enabled within the driver. Logging allows developers to record error events
         * within a text file that can be sent to Linkam for diagnostics. This message allows developers
